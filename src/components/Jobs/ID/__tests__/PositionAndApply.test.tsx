...
describe("PositionAndApply", () => {
  it("should render the postedAt, contract, position, location and apply button of the clicked post data", () => {
    const mockData = {
      id: 1,
      company: "Scoot",
    ...
    render(<PositionAndApply clickedPostData={mockData} />);

    expect(screen.getByText(mockData.postedAt)).toBeInTheDocument();
    expect(screen.getByText(mockData.contract)).toBeInTheDocument();
