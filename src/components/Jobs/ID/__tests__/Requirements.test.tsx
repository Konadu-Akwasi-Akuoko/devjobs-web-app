...
describe("Requirements", () => {
  it("should render the content and items of the requirements of the clicked post data", () => {
    const mockData = {
      id: 1,
      company: "Scoot",
    ...
    render(<Requirements clickedPostData={mockData} />);

    expect(screen.getByText(mockData.requirements.content)).toBeInTheDocument();
    mockData.requirements.items.forEach((item) => {
