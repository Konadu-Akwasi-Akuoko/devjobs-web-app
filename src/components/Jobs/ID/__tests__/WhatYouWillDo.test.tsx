...
describe("WhatYouWillDo", () => {
  it("should render the content and items of the role of the clicked post data", () => {
    const mockData = {
      id: 1,
      company: "Scoot",
    ...
    render(<WhatYouWillDo clickedPostData={mockData} />);

    expect(screen.getByText(mockData.role.content)).toBeInTheDocument();
    mockData.role.items.forEach((item) => {
